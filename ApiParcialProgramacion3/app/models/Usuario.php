...
class Usuario
{
    ...
    public function crearUsuario()
    {
        ...
        $consulta = $objAccesoDatos->prepararConsulta("INSERT INTO usuariosparcial (mail, clave,tipo) VALUES (:mail, :clave, :tipo)");
    ...
    {
        $objAccesoDatos = AccesoDatos::obtenerInstancia();
        $consulta = $objAccesoDatos->prepararConsulta("SELECT id, mail, clave ,tipo FROM usuariosparcial WHERE mail = :mail");
